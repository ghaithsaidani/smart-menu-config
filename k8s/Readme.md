...
3. **Pod Template**:
   - For the **Pod Template**, use the image `ghaithsaidani/jenkins-agent:1.0`. Alternatively, you can build and push your own agent image from the `Dockerfile` located in the `tools/agent/` folder.
